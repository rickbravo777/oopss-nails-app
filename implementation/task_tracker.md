...
| 15 | 2026-08-07 | Admin "Citas"/"Servicios" pages could get stuck on "Cargando…" forever on a failed fetch (no `isError` UI branch) — added error + "Reintentar" to match the pattern already used in Dashboard | completed |
